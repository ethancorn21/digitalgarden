...
Super hard to implement because you have to keep track of what systems are platform dependent create a viable workout for the rest of the code to function in said instance.
